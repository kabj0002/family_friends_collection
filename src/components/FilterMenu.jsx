...
const FilterMenu = () => {
  return (
    <div className="flex gap-3 overflow-scroll mx-2 my-4">
      <div className="flex flex-row items-center gap-2 border-gray-300 border-1 bg-white text-gray-400 text-sm rounded-full pl-3 pr-5 py-2 shrink-0 cursor-pointer">
        <Image
